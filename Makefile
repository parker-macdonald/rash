...
ifeq ($(ERROR_HELL),1)
	CC = clang
	CFLAG_ERRORS = -Weverything -Wno-unsafe-buffer-usage -Wno-declaration-after-statement -Wno-switch-default -Wno-switch-enum -Wno-disabled-macro-expansion -Wno-padded -Wno-pre-c11-compat -Wno-implicit-void-ptr-cast -Wno-date-time -Wno-c++-keyword -Wno-unreachable-code-return
endif
